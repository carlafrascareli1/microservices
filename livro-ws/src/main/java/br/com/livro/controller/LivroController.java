...
public class LivroController {
	...
	public ResponseEntity<Livro> save (@RequestBody final Livro contatoEntity){
		return new ResponseEntity<Livro>(livroDAO.save(contatoEntity), HttpStatus.CREATED);
	}
	
	@CrossOrigin
	@RequestMapping(value="/{id}", method = RequestMethod.PUT)	
	public ResponseEntity<Livro> alter (@PathVariable("id") int id, @RequestBody final Livro contatoEntity) {
		return new ResponseEntity<Livro>(livroDAO.save(contatoEntity), HttpStatus.OK);
	}
