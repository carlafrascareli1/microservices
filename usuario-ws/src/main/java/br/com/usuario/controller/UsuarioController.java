...
public class UsuarioController {
	...
	public ResponseEntity<Usuario> save (@RequestBody final Usuario contatoEntity){
		return new ResponseEntity<Usuario>(usuarioDAO.save(contatoEntity), HttpStatus.CREATED);
	}
	
	@CrossOrigin
	@RequestMapping(value="/{id}", method = RequestMethod.PUT)	
	public ResponseEntity<Usuario> alter (@PathVariable("id") int id, @RequestBody final Usuario contatoEntity) {
		return new ResponseEntity<Usuario>(usuarioDAO.save(contatoEntity), HttpStatus.OK);
	}
