...
public class AutorController {
	...
	public ResponseEntity<Autor> save (@RequestBody final Autor contatoEntity){
		return new ResponseEntity<Autor>(autorDAO.save(contatoEntity), HttpStatus.CREATED);
	}
	
	@CrossOrigin
	@RequestMapping(value="/{id}", method = RequestMethod.PUT)	
	public ResponseEntity<Autor> alter (@PathVariable("id") int id, @RequestBody final Autor contatoEntity) {
		return new ResponseEntity<Autor>(autorDAO.save(contatoEntity), HttpStatus.OK);
	}
