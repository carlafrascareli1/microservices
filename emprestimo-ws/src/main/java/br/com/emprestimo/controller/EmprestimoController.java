...
public class EmprestimoController {
	...
	public ResponseEntity<Emprestimo> save (@RequestBody final Emprestimo contatoEntity){
		return new ResponseEntity<Emprestimo>(emprestimoDAO.save(contatoEntity), HttpStatus.CREATED);
	}
	
	@CrossOrigin
	@RequestMapping(value="/{id}", method = RequestMethod.PUT)	
	public ResponseEntity<Emprestimo> alter (@PathVariable("id") int id, @RequestBody final Emprestimo contatoEntity) {
		return new ResponseEntity<Emprestimo>(emprestimoDAO.save(contatoEntity), HttpStatus.OK);
	}
